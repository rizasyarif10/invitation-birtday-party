export function InvitationFooter() {
  return (
    <footer
      data-reveal
      className="reveal-section relative isolate overflow-hidden bg-[#2b160c] px-5 py-24 text-center text-[#fff1d1] sm:px-8 lg:py-32"
    >
      ...
      <div className="relative mx-auto max-w-2xl">
        <p className="text-xs font-black tracking-[0.3em] text-[#f6a442] uppercase">
          Spooky Fun &amp; Bunny Love
        </p>
        <h2 className="font-playful mt-4 text-4xl leading-tight font-black sm:text-6xl">
          Thank You!
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-[#dfc09d] sm:text-base">
          We look forward to seeing you all to celebrate Rezvan and Reivanya’s
          special day with us.
        </p>
        <p className="font-playful mt-8 text-2xl font-black text-[#ffab42] sm:text-3xl">
